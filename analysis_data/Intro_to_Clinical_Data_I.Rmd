...
clinic[clinic$bcr_patient_barcode=="TCGA-4H-AAAK", "age_at_initial_pathologic_diagnosis"]
patient_1<-clinic[clinic$bcr_patient_barcode=="TCGA-3C-AAAU", "days_to_last_followup"]
patient_1<-patient_1/365
patient_1<-patient_1 + clinic[clinic$bcr_patient_barcode=="TCGA-3C-AAAU", "age_at_initial_pathologic_diagnosis"]
...
```{r Exercise 4.1}
# create plot here
plot(x=clinic$age, y=clinic$age_at_initial_pathologic_diagnosis)
```
...
```{r Exercise 4.2}
# create plot here
boxplot(formula=clinic$age_at_initial_pathologic_diagnosis~clinic$vital_status)
```
...
```{r}
under30_over60_mask <-ifelse(clinic$age_at_initial_pathologic_diagnosis<30, TRUE,ifelse(clinic$age_at_initial_pathologic_diagnosis>60,TRUE, FALSE))
```
