...
rna_counts <- read.csv("/Users/sankalpm/Documents/QBIO_490_sp23/qbio_490_sankalp/analysis_data/brca_rna_count_data.csv")
rna_genes <- read.csv("/Users/sankalpm/Documents/QBIO_490_sp23/qbio_490_sankalp/analysis_data/brca_rna_gene_data.csv")
rna_clinical <- read.csv("/Users/sankalpm/Documents/QBIO_490_sp23/qbio_490_sankalp/analysis_data/brca_rna_clinical_data.csv")
...
```{r}
na_mask <- !is.na(rna_clinical$ajcc_pathologic_stage)  # you can use multiple NA masks if you have multiple columns with NA values (or you can do it all in one!)
...
colnames(results) <- c("Gene Name", "Gene ID", "Log2 Fold Change", "P-value", "PAdj", "-log10(PAdj)") ## FIX
```
...
```{r}
# write code here
write.csv(results, "/Users/sankalpm/Documents/QBIO_490_sp23/qbio_490_sankalp/analysis_data/results.csv", row.names = TRUE)
write.csv(up_reg_results, "/Users/sankalpm/Documents/QBIO_490_sp23/qbio_490_sankalp/analysis_data/up_reg_results.csv", row.names = TRUE)
write.csv(down_reg_results, "/Users/sankalpm/Documents/QBIO_490_sp23/qbio_490_sankalp/analysis_data/down_reg_results.csv", row.names = TRUE)
```
...
EnhancedVolcano(results, 
                ...
                colAlpha = 1)
ggsave("/Users/sankalpm/Documents/QBIO_490_sp23/qbio_490_sankalp/analysis_data/volcano_plot.png")
```
